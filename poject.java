...
class Main {
    public static void main(String[] args) {
        ...
        // Create a Scanner (import it above!) and ask the user how many random
        // passwords they want generated
    ...
    // EXTENSION!!
    // Create a function that returns the password strength ("weak", "medium",
    // "strong") based on the password length
